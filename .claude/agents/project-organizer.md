...
1. Never delete directly — always quarantine first
2. Create `docs/maintenance/_quarantine/YYYY-MM-DD/` folder
3. Move suspect files there with a `_removal-notes.md` explaining why
