...
const MarketingHomePage: React.FC = () => {
  usePageTitle(
    ...
    "Crawl your website, detect SEO and accessibility issues, and get AI-powered recommendations you can act on immediately. Free audit available.",
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-6 leading-relaxed">
              Most audit tools tell you what's wrong. I tell you{" "}
              <strong>what to do about it</strong>,{" "}
              <strong>in what order</strong>, and{" "}
              <strong>how long it'll take</strong> — then show you how you stack
              up against your competition.
            </p>

            <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-12">
              It's not a crawler with an AI bolt-on. It's an AI consultant with
              a crawler built in.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Site Audit Tools Give You Data.
              <br />
              You Need Answers.
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              You've tried the crawlers. They dump 500 rows into a spreadsheet
              and leave you to figure out what matters.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-red-50 border border-red-100 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Great — but which ones matter? A 404 on your pricing page is
                urgent. A broken link to an old blog post? Not so much. Most
                tools treat them the same.
              </p>
            </div>
            ...
            <div className="p-8 bg-red-50 border border-red-100 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                A proper site audit can cost thousands. You get a PDF weeks
                later. Many recommendations are generic. The rest you can't
                implement without paying even more.
              </p>
            </div>
            ...
            <div className="p-8 bg-red-50 border border-red-100 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                A spreadsheet of URLs, status codes, and meta lengths isn't a
                strategy. You need someone to tell you what to fix, why, and in
                what order. That's what this tool does.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Not just metrics. A prioritized action plan with specific fixes
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group p-8 bg-white rounded-xl border border-gray-200 hover:border-secondary-300 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Maps every page, link, image, and heading on your site.
                Auto-detects JavaScript-rendered pages and re-fetches them via
                cloud rendering. No false positives.
              </p>
            ...
            <div className="group p-8 bg-white rounded-xl border border-gray-200 hover:border-secondary-300 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Every page gets a detailed audit card: SEO metadata, content
                depth, image accessibility, link health, response times, and
                heading structure — all color-coded by severity.
              </p>
              <div className="text-sm text-secondary-600 font-medium">
            ...
            <div className="group p-8 bg-white rounded-xl border border-gray-200 hover:border-secondary-300 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 mb-4">
                The kind of report you'd expect from a seasoned strategist —
                generated in minutes. Business-impact prioritization, specific
                fixes, and effort estimates for every recommendation.
              </p>
              <div className="text-sm text-secondary-600 font-medium">
            ...
            <div className="group p-8 bg-white rounded-xl border border-gray-200 hover:border-secondary-300 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Does your homepage sound corporate while your blog sounds
                casual? The AI analyzes tone consistency across your page
                titles, headings, and meta descriptions.
              </p>
              <div className="text-sm text-secondary-600 font-medium">
                No other crawler does this
              </div>
            </div>
            ...
            <div className="group p-8 bg-white rounded-xl border border-gray-200 hover:border-secondary-300 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Crawl your site and a competitor's. Compare structural patterns,
                content depth, and SEO signals to understand where you stand and
                where to improve.
              </p>
              <div className="text-sm text-secondary-600 font-medium">
                Premium feature
            ...
            <div className="group p-8 bg-white rounded-xl border border-gray-200 hover:border-secondary-300 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 mb-4">
                CSV for developers, structured reports for project managers,
                executive summaries for stakeholders. Hand it off and get to
                work.
              </p>
              <div className="text-sm text-secondary-600 font-medium">
                Client-ready output
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you're managing clients, running a business, or building
              your own thing — this tool pays for itself on the first audit.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <Link
              to="/use-cases#seo-agency"
              className="group block bg-white p-8 rounded-xl border border-gray-200 hover:shadow-lg hover:border-secondary-300 transition-all"
            >
              ...
              <p className="text-gray-600 mb-4">
                Audit 10 client sites per day instead of 2. Generate
                client-ready reports in minutes. Use competitive comparison as
                an upsell that closes deals.
              </p>
              ...
              <span className="mt-5 inline-flex items-center gap-1 text-sm font-medium text-secondary-600 group-hover:gap-2 transition-all">
                See this use case
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                No SEO team? No problem. Get plain-English recommendations with
                effort estimates. Know exactly what's a 5-minute fix vs. what
                needs a developer.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-gray-700">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                You built the site. It looks fine. But is it actually working
                for you? Paste your URL, get a complete audit, and see how you
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      A 404 on your pricing page isn't the same as a missing alt
                      tag on a decorative image. The AI knows the difference and
                      ranks accordingly.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      "Change your meta description on /services from [current]
                      to [suggested]." Hand this to your developer. Done.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      No other crawl tool checks whether your site speaks with a
                      consistent voice. I catch mismatches that erode your
                      brand.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Every recommendation tagged: "Quick fix (5 min)" or "Needs
                      developer (2 hrs)." Plan your sprint, not just your
                      wishlist.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-sm">
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-700 flex-shrink-0 mt-0.5">
                      Critical
                    </span>
                    <span className="text-gray-700">
                      Fix 404 at /pricing — high-traffic conversion page
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-sm">
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-yellow-100 text-yellow-700 flex-shrink-0 mt-0.5">
                      Medium
                    </span>
                    <span className="text-gray-700">
                      Meta description on /services is 167 chars (7 over limit)
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-sm">
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-700 flex-shrink-0 mt-0.5">
                      Quick Win
                    </span>
                    <span className="text-gray-700">
                      Add alt text to hero image on homepage
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-secondary-600 to-primary-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 text-secondary-200">
            See exactly what's wrong, what to fix first, and how long each fix
            takes.
          </p>
