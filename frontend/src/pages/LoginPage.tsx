...
const LoginPage: React.FC = () => {
  usePageTitle('Sign In', 'Sign in to AI WebScraper to access your site audits, crawl reports, and AI-powered SEO analysis.');
  ...
  // Force clear any old sessions on mount to get fresh ES256 tokens
  useEffect(() => {
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white bg-gray-800 border border-transparent rounded-md shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
